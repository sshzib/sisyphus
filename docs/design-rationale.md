...
- Production startup verifies that the PostgreSQL migration owner and restricted application role remain separate; deployments still need to provision both credentials securely.
